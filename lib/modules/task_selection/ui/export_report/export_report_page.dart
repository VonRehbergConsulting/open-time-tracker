...
class ExportReportPage extends EffectBlocPage<ExportReportBloc, ExportReportState, ExportReportEffect> {
                      ...
                      InkWell(
                        ...
                        child: Container(
                          ...
                          child: Row(
                            ...
                            children: [
                              Text(AppLocalizations.of(context).export_report_start_date),
                              Text(
                      ...
                      InkWell(
                        ...
                        child: Container(
                          ...
                          child: Row(
                            mainAxisAlignment: MainAxisAlignment.spaceBetween,
                            children: [
                              Text(AppLocalizations.of(context).export_report_end_date),
                              Text(
                    ...
                    children: [
                      ...
                      if (state.isLoadingProjects)
                        ...
                        _ProjectMultiSelect(
                          ...
                          onChanged: (projects) {
                            // Clear and add all selected projects
                            context.read<ExportReportBloc>().clearSelectedProjects();
                            for (final project in projects) {
                              context.read<ExportReportBloc>().toggleProject(project);
                            }
                          },
                        ),
                    ],
                    ...
                    children: [
                      ...
                      SizedBox(
                        ...
                        child: ElevatedButton.icon(
                          onPressed: state.isExporting
                              ? null
                              : () => context.read<ExportReportBloc>().exportAsExcel(),
                          icon: const Icon(Icons.table_chart),
                          label: Text(AppLocalizations.of(context).export_report_xlsx),
                      ...
                      SizedBox(
                        ...
                        child: ElevatedButton.icon(
                          onPressed: state.isExporting
                              ? null
                              : () => context.read<ExportReportBloc>().exportAsPdf(),
                          icon: const Icon(Icons.picture_as_pdf),
                          label: Text(AppLocalizations.of(context).export_report_pdf),
                          style: ElevatedButton.styleFrom(
                            padding: const EdgeInsets.all(16),
                            backgroundColor: const Color.fromRGBO(38, 92, 185, 1),
                            foregroundColor: Colors.white,
                      ...
                      Padding(
                        ...
                        child: TextField(
                          ...
                          decoration: InputDecoration(
                            hintText: AppLocalizations.of(context).export_report_search_projects,
                      ...
                      Flexible(
                        child: ListView.builder(
                          ...
                          itemBuilder: (context, index) {
                            ...
                            final isSelected = widget.selectedProjects.any((p) => p.id == project.id);
                            return ListTile(
                              dense: true,
                              ...
                              trailing: isSelected
                                  ...
                                  : null,
                              onTap: () {
                                final newSelection = List<Project>.from(widget.selectedProjects);
                                if (isSelected) {
    ...
    return CompositedTransformTarget(
      ...
      child: InkWell(
        ...
        child: InputDecorator(
          decoration: InputDecoration(
            labelText: AppLocalizations.of(context).export_report_select_projects,
            border: OutlineInputBorder(
              borderRadius: BorderRadius.circular(8),
            ),
            contentPadding: const EdgeInsets.symmetric(horizontal: 12, vertical: 8),
